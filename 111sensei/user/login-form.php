 ...
 */
	...
	wp_enqueue_style( 'style-form-logo', get_template_directory_uri(). '/111sensei/user/style.css' );
...
<form method="post" name="sensi-login-form" id="loginform" class="login sensei">
	...
	<p class='remember_me' >
		<label for="rememberme" class="inline"><input name="rememberme" type="checkbox" id="rememberme" value="forever" /><?php esc_html_e( 'Remember me', 'sensei-lms' );?></label>
	</p>
