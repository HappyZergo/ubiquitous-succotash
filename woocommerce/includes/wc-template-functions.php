		...
		switch ( $args['type'] ) {
			...
			case 'state':
				...
				if ( is_array( $states ) && empty( $states ) ) {
					...
					$field .= '<input type="text" class="hidden" name="' . esc_attr( $key ) . '" id="' . esc_attr( $args['id'] ) . '" value="" ' . implode( ' ', $custom_attributes ) . ' placeholder="' . esc_attr( $args['placeholder'] ) . '" readonly="readonly" data-input-classes="' . esc_attr( implode( ' ', $args['input_class'] ) ) . '"/>';
