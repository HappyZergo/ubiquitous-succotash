...
<h2 class='enter-title'>ADD PAYMENT METHOD</h2>
		...
		<div id="payment" class="woocommerce-Payment">
			...
			<div class="form-row">
				...
				<div class='payment-form-row'>
					<h2><i class='look-icon'></i>SAFE AND SECURE</h2>
					<p>Your card details are safe with Braintree payment platform’s security and encryption.</p>
				</div>
				<button type="submit" class="woocommerce-Button woocommerce-Button--alt button alt" id="place_order" value="<?php esc_attr_e( 'SAVE PAYMENT METHOD', 'woocommerce' ); ?>"><?php esc_html_e( 'SAVE PAYMENT METHOD', 'woocommerce' ); ?></button>
